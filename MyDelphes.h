...
// Mon Jan  7 11:49:03 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: /Users/navinmcginnis/t4_test/Events/run_01/tag_1_delphes_events.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4182;
   static constexpr Int_t kMaxTrack = 308;
   static constexpr Int_t kMaxTower = 433;
   static constexpr Int_t kMaxEFlowTrack = 308;
   static constexpr Int_t kMaxEFlowPhoton = 188;
   static constexpr Int_t kMaxEFlowNeutralHadron = 163;
   static constexpr Int_t kMaxGenJet = 22;
   ...
   //virtual void     Loop();
    virtual void Loop(TString file_name);
...
#ifdef MyDelphes_cxx
MyDelphes::MyDelphes(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/navinmcginnis/t4_test/Events/run_01/tag_1_delphes_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Users/navinmcginnis/t4_test/Events/run_01/tag_1_delphes_events.root");
      }
...
Int_t MyDelphes::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MyDelphes::LoadTree(Long64_t entry)
{
...
void MyDelphes::Init(TTree *tree)
{
...
void MyDelphes::Show(Long64_t entry)
{
...
Int_t MyDelphes::Cut(Long64_t entry)
{
