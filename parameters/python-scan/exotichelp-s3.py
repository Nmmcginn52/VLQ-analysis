...
#exe("rm t1ewptall-s6.dat")
exe("rm t1ewptall-test-s6.dat")
...
#fin=open("t1ewptallhelp-s6.dat")
fin=open("t1ewptallhelp-test-s6.dat")
...
for i in range(0,len(inhelp)-1):
    ...
    #test
    #gammab4toHH = ((mt4/(64.*pi))*(((lamHpm43)**2 + (lamHpmr43)**2)*(1. + (mbpole**2 - mHH**2)/mt4**2) + 4.*(lamHpm43)*(lamHpmr43)*mbpole/mt4)*sqrt(abs(phase(1.,(mHH/mt4)**2,(mbpole/mt4)**2))))*unitstep(mt4 - mHH - mbpole)
