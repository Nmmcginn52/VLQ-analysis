...
for i in xrange(0,500000):#1000000):#1500000):
    ...
    lamQ = 0.#rng.uniform(-1.0,1.0)
    lamB = 0.#rng.uniform(-1.0,1.0)
    lam = 0.#rng.uniform(-1.0,1.0)#rng.choice([-rng.uniform(0.5,1.0),rng.uniform(0.5,1.0)])
    lamba = 0.#rng.uniform(-1.0,1.0)#rng.choice([-rng.uniform(0.5,1.0),rng.uniform(0.5,1.0)])
    ...
    if mt4 < mHH + mbpole or mb4 < mHH + mt:
        continue
    ...
    #lamHpm43 = -(sin(beta))*( yb*(ULda[1][0])*VR[0][0] ) + (yt*(ULda[1][0])*VR[0][0])*cos(beta)
    ...
    #lamHpmr43 = (cos(beta))*( kaT*(VLda[0][0])*UR[2][1] )
    ...
    if lamHpm43 == 0 and lamHpmr43 == 0:
        print 'lamHpm43 = lamHpmr43 = 0', 'ULda[1][0] =', ULda[1][0], 'UR[2][1] =', UR[2][1], 'ULda[1][2] =', ULda[1][2], 'VR[1][0] =', VR[1][0]
    ...
    fevout=open("t1ewptallhelp-s8.dat", "a+")
