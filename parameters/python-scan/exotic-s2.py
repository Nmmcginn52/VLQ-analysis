...
exe("rm t1ewptallhelp-s9.dat")
#exe("rm t1ewptallhelp-0.5Yukawa.dat")

rng = random.SystemRandom()


for i in xrange(0,500000):#1000000):#1500000):
    MTT = rng.uniform(500.,4000.)#random.uniform(100.,500.)
    MBB = rng.uniform(500.,4000.)#1000
    MQQ = rng.uniform(500.,4000.)
    kaT = 0.#rng.uniform(-1.0,1.0)
    kaQ = 0.#rng.uniform(-1.0,1.0)
    ka = 0.#rng.uniform(-1.0,1.0)
    kab = 0.#rng.uniform(-1.0,1.0)
    ...
    if mt4 < mHH + mbpole or mb4 < mHH + mbpole:
        continue
    ...
    #lamHpmbr43 = -(sin(beta))*( yb*(ULda[0][0])*VR[0][1] + lamB*(ULda[0][0])*VR[2][1]) + (yt*(ULda[0][0])*VR[0][1])*cos(beta)
    ...
    if lamHpmb43 == 0 and lamHpmbr43 == 0:
        print 'lamHpmb43 = lamHpmbr43 = 0', 'VR[0][1] =', VR[0][1], 'VR[2][1] =', VR[2][1]
    ...
    lamHrb34 = -( (MQQ/v)*(VLda[1][1])*VR[1][0] + (MBB/v)*(VLda[1][2])*VR[2][0])*tan(beta)    
    ...
    try:
        delT = (1./(8.*pi*pow(sin(thetaw)*cos(thetaw),2)))*(1/pow(g,2))*( (pow(gLW43t,2) + pow(gRW43t,2))*thetap(yu4,yd3) + 2*gLW43t*gRW43t*thetam(yu4,yd3) + pow(gLW41t,2)*thetap(yu4,yd1) + pow(gLW42t,2)*thetap(yu4,yd2) + (pow(gLW53t,2) + pow(gRW53t,2))*thetap(yu5,yd3) + 2*gLW53t*gRW53t*thetam(yu5,yd3) + pow(gLW51t,2)*thetap(yu5,yd1) + pow(gLW52t,2)*thetap(yu5,yd2) + (pow(gLW44t,2) + pow(gRW44t,2))*thetap(yu4,yd4) + 2*gLW44t*gRW44t*thetam(yu4,yd4) + (pow(gLW54t,2) + pow(gRW54t,2))*thetap(yu5,yd4) + 2*gLW54t*gRW54t*thetam(yu5,yd4) + (pow(gLW55t,2) + pow(gRW55t,2))*thetap(yu5,yd5) + 2*gLW55t*gRW55t*thetam(yu5,yd5) + (pow(gLW34t,2) + pow(gRW34t,2))*thetap(yu3,yd4) + 2*gLW34t*gRW34t*thetam(yu3,yd4) + (pow(gLW35t,2) + pow(gRW35t,2))*thetap(yu3,yd5) + 2*gLW35t*gRW35t*thetam(yu3,yd5) + (pow(gLW45t,2) + pow(gRW45t,2))*thetap(yu4,yd5) + 2*gLW45t*gRW45t*thetam(yu4,yd5) + (pow(gLW33t,2)*thetap(yu3,yd3) - pow(smgLW33,2)*thetap(yuSM3,yd3))  -  2*( (pow(gW3L43t,2) + pow(gW3R43t,2))*thetap(yu4,yu3) + 2*gW3L43t*gW3R43t*thetam(yu4,yu3) + (pow(gW3L53t,2) + pow(gW3R53t,2))*thetap(yu5,yu3) + 2*gW3L53t*gW3R53t*thetam(yu5,yu3) + (pow(gW3L54t,2) + pow(gW3R54t,2))*thetap(yu5,yu4) + 2*gW3L54t*gW3R54t*thetam(yu5,yu4)  )
    ...
    # \Delta S
    try:
        delS = (1./(2.*pi))*(2/pow(g,2))*( (pow(gLW43t,2) + pow(gRW43t,2))*psip(yu4,yd3) + 2*gLW43t*gRW43t*psim(yu4,yd3) + (pow(gLW53t,2) + pow(gRW53t,2))*psip(yu5,yd3) + 2*gLW53t*gRW53t*psim(yu5,yd3) + (pow(gLW44t,2) + pow(gRW44t,2))*psip(yu4,yd4) + 2*gLW44t*gRW44t*psim(yu4,yd4) + (pow(gLW54t,2) + pow(gRW54t,2))*psip(yu5,yd4) + 2*gLW54t*gRW54t*psim(yu5,yd4) + (pow(gLW55t,2) + pow(gRW55t,2))*psip(yu5,yd5) + 2*gLW55t*gRW55t*psim(yu5,yd5) + (pow(gLW34t,2) + pow(gRW34t,2))*psip(yu3,yd4) + 2*gLW34t*gRW34t*psim(yu3,yd4) + (pow(gLW35t,2) + pow(gRW35t,2))*psip(yu3,yd5) + 2*gLW35t*gRW35t*psim(yu3,yd5) + (pow(gLW45t,2) + pow(gRW45t,2))*psip(yu4,yd5) + 2*gLW45t*gRW45t*psim(yu4,yd5)  + ( pow(gLW33t,2)*psip(yu3,yd3)  - pow(smgLW33,2)*psip(yuSM3,yd3) )   -  2*( (pow(gW3L43t,2) + pow(gW3R43t,2))*psip(yu4,yu3) + 2*gW3L43t*gW3R43t*psim(yu4,yu3) + (pow(gW3L53t,2) + pow(gW3R53t,2))*psip(yu5,yu3) + 2*gW3L53t*gW3R53t*psim(yu5,yu3) + (pow(gW3L54t,2) + pow(gW3R54t,2))*psip(yu5,yu4) + 2*gW3L54t*gW3R54t*psim(yu5,yu4)   )
